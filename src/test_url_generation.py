...
class TestURLGeneration:
    ...
    def test_room_range_formatting(self):
        ...
        assert "t4,t5" not in url_params, f"URL should not contain 't4,t5', got: {url_params}"
    ...
    def test_room_configurations(self):
        ...
        test_cases = [
            ...
            (1, 5, "t1,t2,t3-t5"),        # 5 rooms - compress last three
    ...
    def test_no_comma_between_t4_t5(self):
        ...
        for config in configs_to_test:
            ...
            print(f"✅ Config {config.min_rooms}-{config.max_rooms}: No t4,t5 pattern found")
