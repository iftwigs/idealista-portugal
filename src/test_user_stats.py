...
class TestUserStatsManager:
    ...
    def test_stats_persistence_integration(self, temp_stats_file):
        ...
        # Patch the file path
        with patch('user_stats.UserStatsManager.__init__') as mock_init:
...
class TestStatsIntegration:
    ...
    def test_stats_manager_thread_safety(self):
        ...
        total_searches = sum(stats['total_searches'] for stats in manager.stats.values())
...
class TestStatsManagerEdgeCases:
    ...
    @patch('user_stats.json.dump')
    @patch('user_stats.open')
    def test_save_stats_permission_error(self, mock_open, mock_json_dump):
