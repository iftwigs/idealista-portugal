...
class TestBotConversationFlow:
    ...
    async def test_furniture_toggle_flow(self, mock_update, mock_context):
        ...
        bot.user_configs[12345] = SearchConfig()
        original_furniture = bot.user_configs[12345].furniture_types.copy()
        ...
        assert len(bot.user_configs[12345].furniture_types) >= 1
...
class TestConfigurationPersistence:
    ...
    def test_config_save_load(self, temp_config_file):
        ...
        assert FurnitureType.FURNISHED in loaded_config.furniture_types
        assert FurnitureType.KITCHEN_FURNITURE in loaded_config.furniture_types
